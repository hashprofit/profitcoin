...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.01 * COIN;	// 1% interest
...
static const uint256 hashGenesisBlock("0x000008fad98ce9ccdbf167fecc9e0375c0d96b582c84aa09a8c8bc8cf135f221");
static const uint256 hashGenesisBlockTestNet("0x000008fad98ce9ccdbf167fecc9e0375c0d96b582c84aa09a8c8bc8cf135f221");
...
public:
    ...
    {
        // ProfitCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // ProfitCoin: get transaction coin age
...
public:
    ...
    // ProfitCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // ProfitCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // ProfitCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // ProfitCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // ProfitCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // ProfitCoin: block index flags
    enum  
    {
